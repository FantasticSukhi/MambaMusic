...
import config
from MambaMusic import app
from MambaMusic.misc import db
from MambaMusic.utils import AnonyBin, get_channeplayCB, seconds_to_min
from MambaMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from MambaMusic.utils.decorators.language import language, languageCB
from MambaMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://files.catbox.moe/wcjiil.jpg",
        caption=_["queue_1"],
    )
